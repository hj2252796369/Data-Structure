 ...
 * @ClassName T_001_ReverseList
 * @description:
 * @author: huJie
 * @create: 2021-01-05 20:20
 **/
public class T_001_ReverseList {
    ...
    public static Node removeValueInLinkedList(Node head, int value) {
        Node temp = head;
    ...
    public static DoubleNode removeValueInDoubleLinkedList(DoubleNode head, int value) {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < testTime; i++) {
            ...
            DoubleNode reverse2 = reverseDoubleLinkedList(node2);
